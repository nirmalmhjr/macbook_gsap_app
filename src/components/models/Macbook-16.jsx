...
Files: macbook-16.glb [639.28KB] > /Users/nirmalmaharjan/macbook-gsap-app/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        //change color only if child name is not included in noChangeParts constants
